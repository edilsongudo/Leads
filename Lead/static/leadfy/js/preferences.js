...
var basic = initcropper(200, 100, 'square')
var btn = document.querySelector('.desktopbtn')
var image_input = document.querySelector('#id_background_image_desktop')
handle_file_crop(basic, btn, image_input, preview_image, '/desktop/upload/', '.modal', '#cropbutton')
...
var basic2 = initcropper2(100, 200, 'square')
var btn2 = document.querySelector('.mobilebtn')
var image_input2 = document.querySelector('#id_background_image_mobile')
handle_file_crop(basic2, btn2, image_input2, preview_image2, '/mobile/upload/', '.modal2', '#cropbutton2')
