...
urlpatterns = [
    ...
    path('custom_template/', preferences, name="custom_template"),
    path('preferences/', choose_template, name="preferences"),
    ...
    path('to/create/', createlink, name="link-create"),
    path('to/<str:short_url>/edit/', editlink, name="link-edit"),
    ...
    path('pitch/download/', servepitchdeck, name="servepitchdeck"),
